#!/bin/bash
#SBATCH -J bayes_heart                   # job name
#SBATCH -o logs/bayes_heart_%A.out       # stdout log
#SBATCH -e logs/bayes_heart_%A.err       # stderr log
...
PY_SCRIPT="${PROJECT_DIR}/code/BayesAge/bayes_xu_heart.py"  # your script path
