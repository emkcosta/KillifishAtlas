# -*- coding: utf-8 -*-
"""xu_bayes_muscle_2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Rd_05JCnjhnpSmvK8DjuVFrswDBw-q0T
"""
...
# List of directories you want to create
dirs_to_create = [
    "./predictions_exhaustive/muscle/",
    "./reference_exhaustive/muscle/"
]
...
for y_combo in young_combos:
    for o_combo in old_combos:
        ...
        transcriptome_reference(
            ...
            reference_name=f"killifish_muscle_ref_sexcombo_{combo_id}",
            output_path="./reference_exhaustive/muscle/",
            age_prediction="list",
            age_list=new_age_steps,
            min_age=1,
            max_age=24,
        ...
        reference_path = f"./reference_exhaustive/muscle/killifish_muscle_ref_sexcombo_{combo_id}"
        ...
        for gene_number in range(5, 21, 5):
            ...
            df_pred.to_csv(
                f"./predictions_exhaustive/muscle/muscle_sexcombo_pred_top_{gene_number}_{combo_id}.tsv", sep="\t"
            )
