# -*- coding: utf-8 -*-
"""xu_bayes_spleen_2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10eXYLpvMiAGPLRl2rRQtWXUp0ytlKX2B
"""
...
# List of directories you want to create
dirs_to_create = [
    "./predictions_exhaustive/spleen/",
    "./reference_exhaustive/spleen/"
]
...
for y_combo in young_combos:
    for o_combo in old_combos:
        ...
        transcriptome_reference(
            ...
            reference_name=f"killifish_spleen_ref_sexcombo_{combo_id}",
            output_path="./reference_exhaustive/spleen/",
            age_prediction="list",
            age_list=new_age_steps,
            min_age=1,
            max_age=24,
        ...
        reference_path = f"./reference_exhaustive/spleen/killifish_spleen_ref_sexcombo_{combo_id}"
        ...
        for gene_number in range(5, 21, 5):
            ...
            df_pred.to_csv(
                f"./predictions_exhaustive/spleen/spleen_sexcombo_pred_top_{gene_number}_{combo_id}.tsv", sep="\t"
            )
