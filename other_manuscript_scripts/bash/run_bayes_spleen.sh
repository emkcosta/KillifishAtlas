#!/bin/bash
#SBATCH -J bayes_spleen                   # job name
#SBATCH -o logs/bayes_spleen_%A.out       # stdout log
#SBATCH -e logs/bayes_spleen_%A.err       # stderr log
...
PY_SCRIPT="${PROJECT_DIR}/code/BayesAge/bayes_xu_spleen.py"  # your script path
