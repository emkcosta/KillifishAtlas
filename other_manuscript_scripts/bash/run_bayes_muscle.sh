#!/bin/bash
#SBATCH -J bayes_musc                   # job name
#SBATCH -o logs/bayes_musc_%A.out       # stdout log
#SBATCH -e logs/bayes_musc_%A.err       # stderr log
...
PY_SCRIPT="${PROJECT_DIR}/code/BayesAge/bayes_xu_muscle.py"  # your script path
