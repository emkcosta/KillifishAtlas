...
# Batch 3 and 4 were for plates 01 and 02 respectively, but batch 3 was 1 lane of sequencing and batch 4 was
# 2 lanes (merged fastqs were used for mapping and featureCount)

### Merge count matrices
cts.batch3 <- read.csv(paste0(cwd,"/Input/Counts_Atlas_Plate01_Lane02_BatchF003_240407.csv"))
cts.batch4 <- read.csv(paste0(cwd, "/Input/Counts_Atlas_Plate02_Lane02_BatchF004_240417.csv"))
cts.batch.1.2 <- read.csv(paste0(cwd,"/Input/Counts_Atlas_Plate01-02_240319.csv"))
...
write.csv(cts_df, paste0(cwd,"/Output/Counts_Atlas_allbatches_merged.csv"))
...
### Merge TPM matrices
tpm.batch3 <- read.csv(paste0(cwd,"/Input/TPM_Atlas_Plate01_Lane02_BatchF003_240407.csv"))
tpm.batch4 <- read.csv(paste0(cwd,"/Input/TPM_Atlas_Plate02_Lane03-4_BatchF004_240417.csv"))
tpm.batch.1.2 <- read.csv(paste0(cwd,"/Input/TPM_Atlas_Plate01-02_240319.csv"))
...
sampleTable <- read.csv(paste0(cwd,"/Input/240430_alltissuescollected.csv"))
...
write.csv(sampleTable, paste0(cwd,"/Output/ExperimentDesign_allbatches_combined_v3.csv"))
