...
indir = paste0(cwd,"/Output/Tables/")
indir.geneset = '../04_Correlation/Output/Tables/'
...
for(tissue in tissue.list){
  ...
  for(clust in clust.id){
    ...
    outfilename = paste0("Output/Tables/GOBP_250101_Atlas_",tissue,"hClust",clust,".txt")
    ...
    gotermlist = paste0("Output/Tables/GeneGOBP_240101_Atlas_",tissue,"hClust",clust,".txt")
