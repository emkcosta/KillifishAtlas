...
object.indir3 = "../03_DESeq2/Output/robjects/"
object.indir4 = "../04_Correlation/Output/robjects/"

load(paste0(object.indir3,'dds_TPS_allsamples_Gonadcombo_240714.bin'))
load(paste0(object.indir4,'dds_BulkSeq_Aging_CorrelationResults_allsamples_Gonadcombo_TPMcutoff_240714.bin')) #sexes combined corr results

indir = "../04_Correlation/Output/Tables/"
...
tpm <- read.csv('../03_DESeq2/Input/TPM_Atlas_allbatches_merged_v3.csv', row.names = 1)
...
clust.outdir.v1 = paste0(cwd,"/Output/Tables/")
