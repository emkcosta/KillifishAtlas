...
save(BulkSeq_Agecorrelation_results_list, file='/Output/robjects/dds_BulkSeq_Aging_CorrelationResults_allsamples_Gonadcombo_TPMcutoff_240714.bin')


#Load if you are starting from here
#load('/Output/robjects/dds_BulkSeq_Aging_CorrelationResults_allsamples_Gonadcombo_TPMcutoff_240714.bin')
