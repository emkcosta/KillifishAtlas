...
outdir = paste0(cwd, '/Output/Tables/')
outdir.robj = paste0(cwd, '/Output/robjects/')
...
tissue.list <- names(dds_TPS_list)[2:14] #exclude 'All'
...
for (tissue in tissue.list) {
  ...
  for(i in c('1','2','3','4','5')){
    ...
    save(dds_TPS_agebin_list, results_list,  file='/Output/robjects/dds_TPS_alltissue_byagebin-sexdiffs_DESeq2results_241122.bin')
  }
}
# 
# # ------------------------------------------------------------------
...
# 
# outdir.cor = "C:/Users/Felix/Dropbox/Felix_CodeCheck/EC/03_DESeq2/Output/"
# num_Expressed <- read.csv(file = 'C:/Users/Felix/Dropbox/Felix_CodeCheck/EC/03_DESeq2/Input/240714_numexpressedgenes_alltissues_Gonadcombo_TPMcutoff.csv')
# 
# 
