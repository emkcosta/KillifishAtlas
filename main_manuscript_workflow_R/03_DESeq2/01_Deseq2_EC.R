...
dir.create(paste0(outdir,'robjects/'))
...
for (tissue in tissue.list) {
  ...
  pdf(file = paste0(outdir,"Plots/PCA/Atlas_PCA_",tissue,"_bysex_PC1PC2_240711.pdf", sep = ""), width = 10, height = 10)
  print(biplot(p,
               x = 'PC1', y = 'PC2',
               lab = NA,
               colby = 'sex',
...
for (tissue in tissue.list) {
  ...
  save(dds_CA1_list, results_list_CA1,  file='/Output/robjects/dds_DESeq2_TPS_allsamples_agesbinned_240805.bin')
